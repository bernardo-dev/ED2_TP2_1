...
void intercalablocos (int n, FILE *temp, FILE **fitas, int elementos[DOBRO], lista blocos[DOBRO]){
    ...
    // Elementos conta a quantidade de elementos por fita
    // Temp, onde sera escrito o resultado final
    // Tbm usa um lista de blocos para intercalacao
...
int main() {
    ...
    // Gera Arquivos de fitas com os valores em ordem, de acordo com os blocos
